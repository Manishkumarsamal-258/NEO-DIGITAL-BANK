...
public class Account {
    ...
    public Account(String id, String userId, String accountNumber, AccountType accountType, Double balance,
                   String currency, AccountStatus status, LocalDate createdAt, Double interestRate) {
