package com.neobank.transaction.model;
...
public class Transaction {
    ...
    public Transaction(String id, String fromAccountId, String toAccountId, String userId, TransactionType type, Double amount, String currency, String description, TransactionStatus status, String reference, Instant createdAt, String beneficiaryName, String category) {
