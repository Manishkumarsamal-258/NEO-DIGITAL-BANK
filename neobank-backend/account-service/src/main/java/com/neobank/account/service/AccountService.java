...
public class AccountService {
    ...
    public Account createAccount(CreateAccountRequest request) {
        ...
        String accountNumber = String.format("%04d-%04d-%04d-%04d", rand.nextInt(10000), rand.nextInt(10000), rand.nextInt(10000), rand.nextInt(10000));
        ...
        Account account = Account.builder()
                .userId(request.getUserId()).accountNumber(accountNumber).accountType(type)
                .balance(request.getInitialDeposit() != null ? request.getInitialDeposit() : 0)
                .currency("USD").status(Account.AccountStatus.active)
    ...
    public Account toggleFreeze(String accountId) {
        ...
        account.setStatus(account.getStatus() == Account.AccountStatus.active ? Account.AccountStatus.frozen : Account.AccountStatus.active);
        return accountRepository.save(account);
    }
